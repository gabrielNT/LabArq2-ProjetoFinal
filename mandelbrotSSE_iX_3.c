...
paralelizou o loop em iX(versão preliminar 3).
*/
...
int main()
{
	...
	FILE * fp;
	char *filename = "_simd_sse_iX_3.ppm";
	...
	// Float utilizado para multiplicar os valores em simdIx
	float valor4 = 4.0;
	int counter; // counter utilizado com auxiliar no calculo de simdIx
